...
- Read the full [Perception Module README](../src/perception/README.md)
- Explore [Integration Tests](../tests/integration/test_perception_pipeline.py) for more examples
- Review [Configuration Reference](../config/perception_params.yaml)
- Check out [Module 002 Specification](../specs/007-module-002-perception-and-sensors/spec.md)
