...
from app.utils.system_metrics import get_detailed_health_status
...
async def health_check():
    ...
    # Update the status with component information
...
# Phase 3: Auth Router (Better Auth integration)
